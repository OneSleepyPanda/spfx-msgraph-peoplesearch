...
export class SearchService implements ISearchService {
  ...
  public async searchUsers(): Promise<PageCollection<ExtendedUser>> {
    ...
    if (!isEmpty(this.searchParameter)) {
      resultQuery = resultQuery.query({ $search: `"displayName:${this.searchParameter}" OR "jobTitle:${this.searchParameter}" OR "department:${this.searchParameter}" OR "officeLocation:${this.searchParameter}" OR "businessPhones:${this.searchParameter}"` });
    }
